...
ActiveRecord::Schema[7.1].define(version: 20_251_011_032_140) do
  ...
  create_table 'comments', force: :cascade do |t|
    ...
    t.index %w[tea_art_id created_at], name: 'idx_comments_tea_art_created'
  ...
  create_table 'tea_art_tags', force: :cascade do |t|
    ...
    t.index %w[tea_art_id tag_id], name: 'unique_tea_art_tag', unique: true
