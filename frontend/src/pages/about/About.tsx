          ...
          >
            ...
            <div className="flex-1 lg:pt-4">
              ...
              <div className="py-5 text-sm">
                ...
                <br />
                Tea
                Artページでは、ティーの色を調整したり、水面にイラストを描いたり、名前などの詳細を決めて、あなただけのオリジナルティーをメニューに登録できます。
                <br />
        ...
        <div className="flex w-full max-w-4xl flex-col items-center justify-center space-y-8 gap-x-9 sm:flex-row">
          <div className="flex-1 leading-relaxed">
            ...
            <p className="text-sm sm:text-base">
              当カフェで店員として働いているケロ型ロボット。フルネームはピョン・ケロォン・ケロチャ。身長最大96cm、体重最大68kg。人のお世話やおしゃべりが大好きな、好奇心旺盛な子です。
              <br />
              お茶作りに魅了され、たくさんの人をティータイムに招いておもてなしした経験から、“特別な一杯を届けるカフェを作りたい”という夢を持ち、このカフェの誕生に至りました。
              <br />
              ケロチャとCafe Your Teaをどうぞよろしくお願いします。
            </p>
          </div>
